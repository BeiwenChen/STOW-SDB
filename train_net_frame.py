...
# 放在所有 import 最后，确保注册生效
from stow.modeling.pixel_decoder.bifpn import BiFPN

def add_bifpn_config(cfg):
    _C = cfg
    _C.MODEL.BiFPN = CN()
    _C.MODEL.BiFPN.IN_FEATURES = ["res2", "res3", "res4", "res5"]
    _C.MODEL.BiFPN.OUT_CHANNELS = 256
    _C.MODEL.BiFPN.NUM_LAYERS = 3
    _C.MODEL.BiFPN.NORM = "GN"
    _C.MODEL.BiFPN.FUSION = "fast_normalized"
